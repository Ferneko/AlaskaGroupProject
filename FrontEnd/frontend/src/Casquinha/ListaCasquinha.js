          ...
          <div className="col-12">
            <div className="card">
              ...
              <div className="card-body">
                <div className="row">
                  <div className="col-2">
                    <Link to="/CadastroCasquinha" className="btn btn-success">
                      Nova Casquinha
                    </Link>
                  </div>
                  ...
                  <tbody>
                    {this.state.listaCasquinha.map((item) => (
                      <tr key={item.id}>
                        ...
                        <td>{item.preco}</td>
                        <td>
                          <input type="checkbox" disabled defaultChecked={item.ativo}/>       
                        </td>
                        <td>
                          <Link key={item.id} to={{ pathname: "/EditarCasquinha/" + item.id }} className="btn btn-warning"> Editar </Link>
                        </td>
                        <td>
