          ...
          <div className="col-12">
            <div className="card">
              ...
              <div className="card-body">
                <div className="row">
                  <div className="col-2">
                    <Link to="/CadastroSabores" className="btn btn-success">
                      Novo Sabor
                    </Link>
                  </div>
                  ...
                  <tbody>
                    {this.state.listaSabores.map((item) => (
                      <tr key={item.id}>
                        ...
                        <td>
                          <Link key={item.id} to={{ pathname: "/EditarSabores/" + item.id,}} className="btn btn-warning"> Editar </Link>
                        </td>
                        <td>
